...
a.run=function(a,c){var d,e;if(a){if(!a.posts.length)return void this.trigger(this.EVENT_COMPLETE);for(d=0;d<a.posts.length;d+=1){if(this.posts.length>=this.config("maxNum"))return void this.trigger(this.EVENT_COMPLETE);e=a.posts[d],this.posts.push(e),e.tags&&(this.tags=this.tags.concat(e.tags))}this.offset+=this.step,this.trigger(this.EVENT_PROGRESS)}else this.posts=[],this.tags=[];return b.ajax({url:this.option.url,data:{start:this.offset,num:this.step},dataType:"jsonp",success:b.proxy(this.run,this)}),this},a._createTagData=function(){var a,b,c;for(b={},a=0;a<this.tags.length;a++)c=this.tags[a],b[c]=b[c]?b[c]+1:1;this.tags=[];for(a in b)this.tags.push({name:a,count:b[a]})},/**
	 ...
	 * @return Array
	 */
a.getPosts=function(a,c){var d=[];return a=a||0,c=c||10,b.each(this.posts,function(b,e){if(!(b<a))return!(b>=a+c)&&void d.push(e)}),d},/**
	 * Get the tags
	 *
...
a.getTags=function(a){var b=this.tags;return a&&b.sort(function(b,c){return"asc"===a?b.count-c.count:"desc"===a?c.count-b.count:void 0}),b},/**
	 ...
	 * @return String
	 */
a.getTitleByPost=function(a,b){var c=a["regular-title"]||a["photo-caption"]||a["video-caption"]||a["regular-body"]||a.type||"";return c=c.replace(/\<.+?\>/gi,""),c=b?c.substr(0,b):c}}(TumblrPosts.prototype,jQuery),$(document).ready(function(){
// タグリスト記事出す
!function(){var a=new TumblrPosts({
// ドメインと取得する最大記事数
domain:location.host,maxNum:300});a.bind(a.EVENT_COMPLETE,function(a){
// getTags() でタグリストを取得
$.each(this.getTags(),function(a,b){var c='<li class="level'+(b.count%6+1)+'"><a href="/tagged/'+b.name+'">'+b.name+"</a></li>";$(c).appendTo($("ul#tags"))})}),a.run()}(),
// text投稿のyoutubeもレスポンシブにする
$(".post.text iframe[src*='youtube.com']").wrap("<div class='video-iframe'></div>"),$("iframe[src*='tumblr.com']").addClass("video-iframe"),
// fitvid
$(".video-iframe").fitVids(),$(".mobile-nav-panel").click(function(){$(".header-box-nav").slideToggle(200)}),$(".header-tags a").click(function(){return $(".tag-list").slideToggle(200),!1}),$(".tag-list .close").click(function(){$(".tag-list").slideToggle(200)}),
// laphs
LivePhotos.initialize();
// masonry
var a=$(".index-post-wrapper").css({opacity:0});a.imagesLoaded(function(){a.animate({opacity:1}),a.masonry({itemSelector:".post"})}),
// infinite scroll
a.infinitescroll({navSelector:".pagenation-index",nextSelector:".pagenation-index .next",itemSelector:".post",animate:!1,loading:{img:"//static.tumblr.com/xlsgtjb/V4Zne2alt/blank.gif",msgText:"<div class='spinner'><div class='rect1'></div><div class='rect2'></div><div class='rect3'></div><div class='rect4'></div><div class='rect5'></div></div>",finishedMsg:""}},function(b){var c=$(b).css({opacity:0});c.imagesLoaded(function(){a.animate({opacity:1}),a.masonry("appended",c,!0),LivePhotos.initialize()})}),
// 外部サイトにはtarget blankする
$("a").each(function(){var a=this;a.origin!==location.origin&&$(a).attr("target","_blank")}),$(window).load(function(){
